...
def main(page: ft.Page):
    ...
    def say_hello(e):
        greeting_text.value = (
            f"Hello, {name_input.value}! Welcome to Flet GUI development By CRC!!!"
            if name_input.value else
    ...
    hello_button = ft.ElevatedButton(
        "Say Hello", on_click=say_hello,
        width=120, bgcolor=ft.Colors.BLUE_600, color=ft.Colors.WHITE
    )
    clear_button = ft.ElevatedButton(
        "Clear", on_click=clear_all,
        width=120, bgcolor=ft.Colors.GREY_600, color=ft.Colors.WHITE
    )
    info_button = ft.ElevatedButton(
        "App Info", on_click=show_info,
        width=120, bgcolor=ft.Colors.GREEN_600, color=ft.Colors.WHITE
    )
    ...
    page.add(
        ft.Container(
            content=ft.Column([
                ...
                name_input,
                ft.Row([hello_button, clear_button, info_button],
